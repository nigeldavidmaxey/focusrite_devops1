 ...
 * @endcode
 */
$settings['hash_salt'] = 'T6TGTRBnZ5GOKAWT98vduLsnQqvQqDP18-oFLFqjfDdkEB9ioWQs6lznyJvKDv0uUMMdQ_eNTA';
...
//$settings['trusted_host_patterns'] = [
   //'^webdev\.staging\.focusrite\.nigel$',
   //'^focusrite-staging-test-1\.dd:8083$',
//];
/*
 * @endcode
...
$config_directories['sync'] = 'sites/default/files/config_qZDOqveOcYpMLqtn14DoZaX17RkqeLdQW3JhlM6fEoNPAHT5YIFpELe-Se-YkLsBS1YSxiqBhA/sync';

// <DDSETTINGS>
// Please don't edit anything between <DDSETTINGS> tags.
// This section is autogenerated by Acquia Dev Desktop.
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_focusrite_staging_test_1_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_focusrite_staging_test_1_dd.inc';
}
// </DDSETTINGS>
